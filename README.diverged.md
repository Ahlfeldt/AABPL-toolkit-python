...
| `spacing` | `float` | Output grid cell size, in the same unit as `r`. Sets the resolution of exports/plots, not the internal search grid (which is auto-sized for speed). Defaults to `r/3`. |
