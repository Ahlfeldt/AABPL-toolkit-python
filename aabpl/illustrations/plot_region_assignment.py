...
def illustrate_point_to_cell_region_assignment(
    ...
    **plot_cell_reg_assign,
    ...
    (cells_cntd_in_all_disks, 
     ...
     cells_maybe_overlapping_a_trgl_disk) = classify_disk_cells(
    ...
    add_grid_cell_rectangles_by_color(
        [cells_cntd_in_all_disks, cells_maybe_overlapping_a_disk],
        ['green', 'red'],
    ...
    add_grid_cell_rectangles_by_color(
        [cells_maybe_overlapping_a_disk, cells_cntd_in_all_disks,cells_cntd_in_all_trgl_disks, cells_maybe_overlapping_a_trgl_disk],
        ['#ccc', 'blue', 'green', 'red'],
        ax=ax, grid_spacing=grid_spacing
    )
